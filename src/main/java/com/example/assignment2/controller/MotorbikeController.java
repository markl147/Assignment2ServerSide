...
public class MotorbikeController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println(motorbikeID + email + make + model + cc);
        ArrayList<Motorbike> listOfMotorbikes = new ArrayList();

        Motorbike b1 = new Motorbike(motorbikeID, email, make, model, cc);
        listOfMotorbikes.add(b1);
        Motorbike b2 = new Motorbike(null, "suzie@gmail.com", "Suzuki", "Bandit", "600");
        Motorbike b3 = new Motorbike(null, "Billy@gmail.com", "Honda", "VTX", "1300");
